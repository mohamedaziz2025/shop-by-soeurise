...
let ReviewsController = class ReviewsController {
    ...
    async respondToReview(id, user, respondDto) {
        return this.reviewsService.respondToReview(id, user.userId, respondDto);
    }
    async getAllReviews(filters) {
        return this.reviewsService.findAll(filters);
    }
    async moderateReview(id, user, body) {
        return this.reviewsService.moderateReview(id, user.userId, body.status, body.reason);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, review_dto_1.RespondToReviewDto]),
    __metadata("design:returntype", Promise)
